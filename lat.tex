...
We would also recommend Alice \& Bob to use salting, which is a method that produces a random string of charactors,
that is concatenated with the original plantext message.
...
Firstly we newer recommend using standard hash function like Sha alone.
We would recommend using KDF functions like Argon2, Bcrypt and Scrypt. These are designed specifically for storaging passwords securely.
